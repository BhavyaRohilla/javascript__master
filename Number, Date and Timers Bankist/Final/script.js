...
const account1 = {
  ...
  movementsDates: [
    ...
    '2024-08-21T09:15:04.904Z',
    '2024-08-22T10:17:24.185Z',
    '2024-08-23T14:11:59.604Z',
    '2024-08-24T17:01:17.194Z',
    '2024-08-20T23:36:17.929Z',
    '2024-08-25T10:51:36.790Z',
  ],
  currency: 'EUR',
  locale: 'pt-PT', // de-DE
};
...
btnLoan.addEventListener('click', function (e) {
  ...
  if (amount > 0 && currentAccount.movements.some(mov => mov >= amount * 0.1)) {
    setTimeout(function () {
      ...
      clearInterval(timer);
      timer = startLogOutTimer();
    }, 2500); // wait for the loan to be processed
  }
...
console.log(56896454563174554212442545635374545315645645646546456n);
console.log(BigInt(45656456345645634));

// Operations
console.log(10000n + 10000n);

const huge = 54531534563486135274n;
const num = 23;
